...
export default function Footer() {
  ...
  useEffect(() => {
    const tick = () =>
      setUtc(new Date().toISOString().substring(11, 19) + ' UTC');
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="flex flex-col gap-3 max-w-sm">
            <div className="flex items-center gap-3">
              ...
              <span
                className="text-[#dae2fd] text-[13px] font-bold uppercase tracking-widest"
            ...
            <p
              className="text-[#bcc9cd] text-[13px] leading-relaxed opacity-70"
              style={{ fontFamily: 'Inter' }}
            >
              Transforming single-pass drone video into high-fidelity 3D
          ...
          <div className="flex flex-col gap-3">
            <span
              className="text-[#869397] text-[10px] uppercase tracking-widest"
              style={{ fontFamily: "'JetBrains Mono', monospace" }}
            >
              Navigate
            </span>
            ...
            <div className="flex flex-col gap-2">
              {FOOTER_LINKS.map(({ label, path }) => (
                <Link
                  key={path}
                  href={path}
                  className="text-[#bcc9cd] hover:text-[#4cd7f6] text-[13px] transition-colors"
                  style={{ fontFamily: 'Inter' }}
                >
                  {label}
                </Link>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#bcc9cd] text-[12px]">
                  All systems operational
                </span>
              </div>

              <span className="text-[#4cd7f6] text-[12px] tabular-nums">
                {utc}
              </span>
            </div>
          </div>
